...
const TOOLS = [
  /* ── 💰 Finance & Business ─────────────────────────────── */
  {
    ...
    hot: true,
    desc: "Inclusive & exclusive · CGST/SGST/IGST breakup",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: true,
    desc: "Home · Car · Education loan breakdown + chart",
    color: "#7c3aed",
  },
  {
    g: "💰 Finance",
    ...
    hot: true,
    desc: "Sale price · Savings amount instantly",
    color: "#059669",
  },
  {
    g: "💰 Finance",
    ...
    hot: true,
    desc: "Total interest · Monthly EMI · Amortization",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Cost · Selling price · Markup %",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Multi-product · GST · Break-even analysis",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
  ...
  },
  {
    ...
    hot: false,
    desc: "Discount · Marks · GST · Price change %",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Monthly savings · Target amount · Goal planner",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Gross · Net · TDS · HRA breakdown",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Principal · Rate · Time calculation",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Monthly/yearly compounding · FD returns",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Simple & compound interest · FD calculator",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ico: "💳",
    name: "Credit Card Interest Calc",
    path: "/tools/credit-card-interest-calculator",
    hot: false,
    desc: "Outstanding balance · APR · Min payment",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "All types of interest calculation",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "ROI · CAGR · Total return estimate",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Sales commission · Rate calculation",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Cost to price · Markup percentage",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Gross margin · Net margin calculation",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Fixed costs · Variable costs · BEP",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Best deal comparison · Per unit cost",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Restaurant bill · Split tip among friends",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ico: "📈",
    name: "Percentage Increase Calc",
    path: "/tools/percentage-increase-calculator",
    hot: false,
    desc: "% increase between two values",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ico: "📉",
    name: "Percentage Decrease Calc",
    path: "/tools/percentage-decrease-calculator",
    hot: false,
    desc: "% decrease between two values",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ico: "🔄",
    name: "Percentage Change Calc",
    path: "/tools/percentage-change-calculator",
    hot: false,
    desc: "% change between old and new value",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ico: "📊",
    name: "Percentage Difference Calc",
    path: "/tools/percentage-difference-calculator",
    hot: false,
    desc: "Difference between two percentages",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Home loan EMI · Amortization schedule",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Retirement corpus · Monthly pension estimate",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Assets · Liabilities · Total net worth",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    path: "/tools/cost-per-unit-calculator",
    hot: false,
    desc: "Manufacturing cost · Per unit pricing",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    path: "/tools/tax-percentage-calculator",
    hot: false,
    desc: "Tax amount · Effective tax rate",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Purchasing power · Real value of money",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Monthly savings needed · Goal tracker",
    color: "#2563eb",
  },
  {
    g: "💰 Finance",
    ...
    hot: false,
    desc: "Investment recovery · Break-even period",
    color: "#2563eb",
  },
  ...
  /* ── ⚡ Electricity & Solar ─────────────────────────────── */
  {
    ...
    path: "/tools/bijli",
    hot: true,
    desc: "7 states · 2026 latest UPCL rates · Full breakup",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: true,
    desc: "Meter reading · Slab breakup · Saving tips",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: true,
    desc: "Payback period · Annual savings · NPV",
    color: "#059669",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: true,
    desc: "VA sizing · Battery Ah · UPS planning",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Daily/monthly/yearly appliance cost",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ico: "🏠",
    name: "Power Consumption Planner",
    path: "/tools/power-consumption-planner",
    hot: false,
    desc: "Appliances · Monthly units · Bill estimate",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ico: "⚡",
    name: "Power Consumption Calc",
    path: "/tools/power-consumption-calculator",
    hot: false,
    desc: "Watts to kWh · Electricity cost per month",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Panel size · Battery capacity · Load matching",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Backup hours · Ah capacity needed · VA rating",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Wire gauge · Resistance · Voltage drop %",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Cable size · Current load · Distance",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Home appliances power & electricity bill",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    path: "/tools/electrical-load-calculator",
    hot: false,
    desc: "Total electrical load · Circuit planning",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ico: "⚡",
    name: "Energy Consumption Calc",
    path: "/tools/energy-consumption-calculator",
    hot: false,
    desc: "kWh consumption · Monthly cost estimate",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    path: "/tools/led-resistor-calculator",
    hot: false,
    desc: "LED circuit resistance · Voltage/current",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    path: "/tools/ohms-law-calculator",
    hot: false,
    desc: "Voltage · Current · Resistance · Power",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Power factor · Real vs apparent power",
    color: "#d97706",
  },
  {
    g: "⚡ Electricity",
    ...
    hot: false,
    desc: "Units consumed · Bill amount · Slab rates",
    color: "#d97706",
  },
  ...
  /* ── 🖼️ Image Tools ─────────────────────────────────────── */
  {
    ...
    hot: true,
    desc: "File size kam karo · Quality control · Bulk",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: true,
    desc: "Social media · Web presets · Custom size",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: true,
    desc: "JPG/PNG/WebP conversion · Quality control",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: true,
    desc: "White/solid bg remove · Transparent PNG output",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Pixel-precise crop · Custom dimensions",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Rotate 90°/180°/270° · Any direction",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Horizontal & vertical flip · Mirror image",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Text watermark · Position · Opacity control",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Color to black & white · Instant preview",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Gaussian blur · Intensity slider control",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Brighten or darken photos · Slider control",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Increase/decrease image contrast",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Boost or reduce color saturation (HSL)",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Sharpen blurry photos · Unsharp mask",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Add colored border/frame · Size control",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Combine 2–4 photos in grid layouts",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Upload or paste screenshot · Convert format",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Image to Base64 data URL · Copy & use",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "Base64 string back to image · Download",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
    ...
    hot: false,
    desc: "EXIF data · Dimensions · File info",
    color: "#0891b2",
  },
  {
    g: "🖼️ Image",
  ...
  /* ── 📝 Text Tools ──────────────────────────────────────── */
  {
    ...
    hot: true,
    desc: "Words · Characters · Sentences · Reading time",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Total chars · With/without spaces",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Count sentences · Reading level check",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
  ...
  },
  {
    ...
    hot: false,
    desc: "Upper/lower/title/sentence/camel case",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
  ...
  },
  {
    ...
    hot: false,
    desc: "Reverse text/words/characters/lines",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Clean text lists · Remove repeated lines",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Clean extra spaces · Trim whitespace",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Sort lines A-Z or Z-A alphabetically",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Compare two texts · Highlight differences",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Plain text to HTML tags converter",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Strip HTML tags · Get clean text",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Count lines in text · Numbered output",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Placeholder text · Custom length/format",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "SEO-friendly URL slug generator",
    color: "#7c3aed",
  },
  {
    g: "📝 Text",
    ...
    hot: false,
    desc: "Random sentences/words/paragraphs",
    color: "#7c3aed",
  },
  ...
  /* ── 📱 Content & Social Media ──────────────────────────── */
  {
    ...
    hot: true,
    desc: "Instagram/Twitter hashtags · Niche-based",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: true,
    desc: "Engaging captions · Emojis · CTAs",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: false,
    desc: "Professional bio · Niche-based templates",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: false,
    desc: "Click-worthy titles · SEO optimized",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ico: "📋",
    name: "YouTube Description Gen",
    path: "/tools/youtube-description-generator",
    hot: false,
    desc: "SEO description · Tags · Chapters",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: false,
    desc: "Extract thumbnails from any YouTube video",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: false,
    desc: "ChatGPT/Claude prompt ideas · Category-wise",
    color: "#e11d48",
  },
  {
    g: "📱 Content",
    ...
    hot: false,
    desc: "Blog/video ideas · Niche-based topics",
    color: "#e11d48",
  },
  ...
  /* ── 🔧 Generators & Utilities ──────────────────────────── */
  {
    ...
    hot: true,
    desc: "Strong secure passwords · Custom rules",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Unique usernames · Platform-based",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Creative business names · Industry-based",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Available domain ideas · .com/.in options",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Indian & global names · Male/female",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Cryptographically random passwords",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Test/demo addresses · India-based",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Temporary email addresses for testing",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Harmonious color schemes · HEX/RGB",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "CSS gradient code · Color picker",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "SEO-friendly URL slugs · Auto-clean",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: true,
    desc: "URL · WiFi · UPI · Contact QR codes",
    color: "#0f172a",
  },
  {
    g: "🔧 Generators",
    ...
    hot: false,
    desc: "Speed · SEO · Mobile · Core Web Vitals",
    color: "#0f172a",
  },
  ...
  /* ── 🧮 Math & Science ──────────────────────────────────── */
  {
    ...
    hot: false,
    desc: "Mean of numbers · Sum/count/avg",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    hot: false,
    desc: "Simplify ratio · Equivalent ratios",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
  ...
  },
  {
    ...
    hot: false,
    desc: "Square root · Cube root · Nth root",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    path: "/tools/cube-calculator",
    hot: false,
    desc: "Cube value · Volume · Power of 3",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ico: "log",
    name: "Log Calculator",
    path: "/tools/log-calculator",
    hot: false,
    desc: "Log base 10 · Natural log · Log2",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
  ...
  },
  {
    ...
    hot: false,
    desc: "n! factorial · Large number support",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ico: "🔢",
    name: "GCD Calculator",
    path: "/tools/gcd-calculator",
    hot: false,
    desc: "Greatest Common Divisor · HCF",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ico: "🔢",
    name: "LCM Calculator",
    path: "/tools/lcm-calculator",
    hot: false,
    desc: "Least Common Multiple · Multi-number",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    path: "/tools/mean-calculator",
    hot: false,
    desc: "Arithmetic mean · Dataset average",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    path: "/tools/median-calculator",
    hot: false,
    desc: "Middle value · Sorted data median",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    path: "/tools/mode-calculator",
    hot: false,
    desc: "Most frequent value in dataset",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    hot: false,
    desc: "Population & sample std deviation",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    hot: false,
    desc: "Min-max range · Multiple numbers",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
    ...
    hot: false,
    desc: "nPr · nCr · Arrangements · Selections",
    color: "#4f46e5",
  },
  {
    g: "🧮 Math",
  ...
  },
  {
    ...
    hot: false,
    desc: "Advanced math · Trigonometry · Logs",
    color: "#4f46e5",
  },
  ...
  /* ── 🏥 Health & Fitness ────────────────────────────────── */
  {
    ...
    hot: true,
    desc: "Body Mass Index · Healthy weight range",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Basal Metabolic Rate · Daily calories needed",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Daily calorie needs · Weight goal planning",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Body fat % · Navy method · BMI method",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Daily water requirement · Weight-based",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Target HR zones · Max heart rate by age",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ...
    hot: false,
    desc: "Ideal body weight · Height-based formulas",
    color: "#16a34a",
  },
  {
    g: "🏥 Health",
    ico: "⚖️",
    name: "Ideal Body Weight Calc",
    path: "/tools/ideal-body-weight-calculator",
    hot: false,
    desc: "IBW using Devine, Robinson, Miller formulas",
    color: "#16a34a",
  },
  ...
  /* ── 🏗️ Construction & Home ─────────────────────────────── */
  {
    ...
    hot: false,
    desc: "Bricks needed · Mortar · Wall dimensions",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Cement · Sand · Aggregate · Volume",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Litres needed · Room coverage area",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Tiles needed · Grout · Room area",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Flooring area · Material quantity",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Roof area · Material estimate",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Rise · Run · Total stairs calculation",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Tons needed · Road/driveway paving",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Cubic yards/tons · Coverage area",
    color: "#b45309",
  },
  {
    g: "🏗️ Construction",
    ...
    hot: false,
    desc: "Sand quantity · Area coverage estimate",
    color: "#b45309",
  },
  ...
  /* ── 📐 Unit Converters ─────────────────────────────────── */
  {
    ...
    hot: false,
    desc: "mm/cm/m/km/inch/feet/mile/yard",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
    ...
    hot: false,
    desc: "kg/g/lb/oz/ton — all weight units",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
  ...
  },
  {
    ...
    hot: false,
    desc: "L/mL/gallon/cubic meter/cubic feet",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
  ...
  },
  {
    ...
    hot: false,
    desc: "sec · min · hours · days · weeks · years",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
  ...
  },
  {
    ...
    hot: false,
    desc: "Watts · kW · horsepower · BTU/hr",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
  ...
  },
  {
    ...
    hot: false,
    desc: "L/100km · km/L · MPG conversion",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
    ...
    hot: false,
    desc: "kg/m³ · g/cm³ · lb/ft³ conversion",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
    ...
    hot: true,
    desc: "INR · USD · EUR · GBP · live rates",
    color: "#0369a1",
  },
  {
    g: "📐 Converters",
    ...
    hot: true,
    desc: "All-in-one unit conversion tool",
    color: "#0369a1",
  },
  ...
  /* ── ⏱️ Date & Time ─────────────────────────────────────── */
  {
    ...
    hot: true,
    desc: "Exact age · Days lived · Next birthday",
    color: "#be185d",
  },
  {
    g: "⏱️ Date & Time",
    ...
    hot: false,
    desc: "Difference between two birth dates",
    color: "#be185d",
  },
  {
    g: "⏱️ Date & Time",
    ...
    hot: false,
    desc: "Days between dates · Weeks/months/years",
    color: "#be185d",
  },
  {
    g: "⏱️ Date & Time",
    ...
    hot: false,
    desc: "Time difference · Hours/minutes/seconds",
    color: "#be185d",
  },
  {
    g: "⏱️ Date & Time",
    ...
    hot: false,
    desc: "Daily work hours · Overtime · Total time",
    color: "#be185d",
  },
  ...
  /* ── 🚗 Travel & Distance ───────────────────────────────── */
  {
    ...
    hot: false,
    desc: "Trip fuel cost · Distance/mileage",
    color: "#7e22ce",
  },
  {
    g: "🚗 Travel",
    ...
    hot: false,
    desc: "Speed · Time · Distance triangle",
    color: "#7e22ce",
  },
  {
    g: "🚗 Travel",
    ...
    hot: false,
    desc: "Distance between points · km/miles",
    color: "#7e22ce",
  },
];
...
const DEFAULT_PASSIVE_LINKS = [
  {
    id: "pl1",
    ico: "🏦",
    title: "Loan Apply Karo",
    sub: "BankBazaar · Best rate · 2 min",
    color: "#2563eb",
    bg: "#eff6ff",
  ...
  },
  {
    ...
    ico: "💳",
    title: "Credit Card",
    sub: "Best cards · Rewards + cashback",
    color: "#e11d48",
    bg: "#fff1f2",
  ...
  },
  {
    ...
    ico: "☀️",
    title: "Solar Install",
    sub: "Free site visit · 40% subsidy",
    color: "#d97706",
    bg: "#fffbeb",
    url: "/solar-solutions",
    active: true,
    ...
    >
      ...
      >
        <div>
          ...
          >
            Tool Use Kiya? Ab Paisa Bhi Kamao
          </div>
          <div style={{ fontSize: "0.78rem", color: "#64748b", marginTop: 2 }}>
            In links se apply karo — hume commission milti hai, aapko kuch extra
            nahi lagta
          </div>
        </div>
      </div>
        ...
        {activeItems.map((item) => (
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div
                style={{ fontSize: "0.68rem", color: "#64748b", marginTop: 2 }}
              >
                {item.sub}
              </div>
            </div>
      ...
      >
        * Affiliate links — purchase/apply karne pe hume commission milti hai ·
        Aapko koi extra charge nahi
      </p>
    </div>
  );
});
    ...
    <div style={{ marginBottom: 24 }}>
      ...
      >
        ...
        <div>
          ...
          <div
            style={{ fontSize: "0.7rem", color: "#64748b", fontWeight: 600 }}
          >
...
export default function ToolsPage() {
  ...
  const hiddenTools = Array.isArray(settings.hiddenTools)
  ...
  const VISIBLE_TOOLS = MERGED_TOOLS.filter(
    (t) => !hiddenTools.includes(t.slug || t.path?.split("/").pop()),
  );
  ...
  const groupedFiltered = useMemo(() => {
    ...
    return GROUPS.map((g) => ({
      group: g,
      tools: VISIBLE_TOOLS.filter((t) => t.g === g),
  ...
  const goTo = useCallback((path) => () => nav(path), [nav]);
  const showGrouped =
    !search && activeGroup === "All" && viewMode === "category";
      ...
      <div className="tp2-page">
        ...
        <div className="tp2-hero">
          ...
          <div className="tp2-hero-inner">
            ...
            <p className="tp2-sub">
              GST, EMI, Bijli Bill, Image Tools, Solar ROI, Health —{" "}
              {TOOLS.length}+ calculators. Bilkul free, koi login nahi!
            </p>
        ...
        <div className="tp2-body">
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      viewMode === "category" ? "#fff" : "transparent",
                    color: viewMode === "category" ? "#0f172a" : "#64748b",
                    boxShadow:
                      viewMode === "category"
          ...
          {filtered.length > 0 ? (
            ...
            <div className="tp2-empty">
              ...
              <div className="tp2-empty-title">
                "{search}" ke liye koi tool nahi mila
              </div>
              <div className="tp2-empty-sub">
                Try karo: "GST", "EMI", "image", "bijli", "BMI", "loan"
              </div>
              <button className="tp2-empty-reset" onClick={clearSearch}>
                ✕ Clear Search
              </button>
            </div>
          )}
          ...
          <div className="tp2-aff-section">
            <div className="tp2-aff-head">
              <div>
                ...
                <h2 className="tp2-aff-title">
                  Tool Use Karo, Products Bhi Dekho
                </h2>
                <p className="tp2-aff-sub">
                  Expert picks — electrician, solar & home products · Fast
                  Amazon delivery
                </p>
              </div>
            </div>
          ...
          <div className="tp2-seo-card">
            ...
            <p>
              Almenso par {TOOLS.length}+ free online tools hain jo Indian users
              ke liye banaye gaye hain. GST calculation, EMI planning, bijli
              bill check, solar ROI, image editing, health calculators — sab ek
              jagah. Koi registration nahi, koi login nahi — seedha use karo!
            </p>
            <p>
              Haldwani, Uttarakhand se shuru hua Almenso aaj India bhar mein use
              ho raha hai. Hamare tools teachers, students, shop owners,
              electricians, aur families sab use karte hain.
            </p>
